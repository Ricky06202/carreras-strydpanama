...
const racesCollection: CollectionConfig = {
  ...
  schema: {
    ...
    properties: {
      ...
      description: { type: 'easymde', title: 'Descripción' },
      ...
      technicalInfo: { type: 'easymde', title: 'Información Técnica' },
      termsAndConditions: { type: 'easymde', title: 'Términos y Condiciones' },
